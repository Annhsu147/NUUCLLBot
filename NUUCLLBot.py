...
def testIntent():
    # graduation
    print("[TEST] graduation")
    inputLIST = ['想要畢業','畢業的條件','如何才可以畢業','怎麼才能夠畢業','畢業所需的要求','畢業有哪些條件','修完幾個學分就能畢業','有多少個學分就能畢業','有幾個學分才能夠畢業','修完幾個學分才可以畢業','修完幾個學分才能夠畢業','要多少個學分才可以畢業']
    testLoki(inputLIST, ['graduation'])
    print("")

    # introduction
    print("[TEST] introduction")
    inputLIST = ['華文系的介紹','什麼是華語文學','介紹你們華文系','華語文學是什麼']
    testLoki(inputLIST, ['introduction'])
    print("")

    # shixi_place
    print("[TEST] shixi_place")
    inputLIST = ['實習的地點','可以去哪裡實習','國內的實習的地點','實習的地點有哪些','有哪些實習的地點','海外的實習的地點','可以去甚麼地方實習','有多少個海外的實習','可以去哪些海外的實習','可以有哪幾個海外的實習','海外的實習的國家有哪些','海外的實習可以去哪些國家','海外的實習的國家有哪幾個','海外的實習可以去哪幾個國家']
    testLoki(inputLIST, ['shixi_place'])
    print("")

    # shixi
    print("[TEST] shixi")
    inputLIST = ['實習','國內的實習','海外的實習','一定要去實習嗎','只想在國內實習','可以去國外實習嗎','一定要到國外實習嗎','了解有關國內的實習','了解有關國外的實習','了解關於國內的實習','了解關於國外的實習','我對國內實習感興趣','我對國外實習有興趣','提供一些有關國內的實習的詳細資訊','提供一些有關國外的實習的詳細資訊','提供一些關於國內的實習的詳細資訊','提供一些關於國外的實習的詳細資訊','提供一些和國外的實習有關的詳細資訊','提供一些跟國內的實習有關的詳細資訊','提供一些跟國內的實習相關的詳細資訊','提供一些跟國外的實習相關的詳細資訊']
    testLoki(inputLIST, ['shixi'])
    print("")

    # shixi_time
    print("[TEST] shixi_time")
    inputLIST = ['實習的時長','實習的時間','實習要多久','要實習多久','實習的時間怎麼說','有規定實習時間嗎','實習通常在什麼時候','甚麼時間可以去實習','實習期間需要工作多久','實習的時間有被規定嗎','實習的時間是怎麼安排的','實習的時間安排是怎麼樣的','實習的時間是被規定好的嗎']
    testLoki(inputLIST, ['shixi_time'])
    print("")
